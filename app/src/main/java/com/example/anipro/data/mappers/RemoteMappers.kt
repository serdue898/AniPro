...
import com.example.anipro.data.network.response.Alternative_titles
import com.example.anipro.data.network.response.Broadcast
import com.example.anipro.data.network.response.Genre
import com.example.anipro.data.network.response.Main_picture
import com.example.anipro.data.network.response.Node
import com.example.anipro.data.network.response.Start_season
import com.example.anipro.data.network.response.Studio
import com.example.anipro.model.AnimeItem
import com.example.anipro.model.alternative_titles
import com.example.anipro.model.broadcast
import com.example.anipro.model.genre
import com.example.anipro.model.main_picture
import com.example.anipro.model.start_season
import com.example.anipro.model.studio
